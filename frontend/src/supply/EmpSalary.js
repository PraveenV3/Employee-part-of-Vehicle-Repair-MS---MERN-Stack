...
const EmpSalary = () => {
  ...
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', overflow: 'hidden' }}>
      <Header />
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '30px', padding: '20px', overflow: 'hidden' }}>
        <Sidebar />
        <div style={{ width: 'calc(100% - 320px)', background: '#fff', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)', padding: '20px', borderRadius: '5px' }}>
